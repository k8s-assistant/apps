**This repo is an reboot of [k8-at-home](https://github.com/k8s-at-home/)
...
```console
helm repo add k8s-assistant https://github.com/k8s-assistant/apps/chars/
```
...
- Visit our [Docs](https://docs.k8s-assistant.com/).
- Bugs or feature requests should be opened in an [issue](https://github.com/k8s-assistant/apps/issues/new/choose).
- Questions or comments should be discussed in [Github discussions](https://github.com/k8s-at-home/organization/discussions).
